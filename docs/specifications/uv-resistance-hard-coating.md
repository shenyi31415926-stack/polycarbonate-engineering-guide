# UV Resistance in Polycarbonate: Hard Coating Performance Analysis

**Technical Guide** | Material Science | May 2026  
...
UV degradation is the primary failure mode for unprotected polycarbonate in outdoor applications. This guide analyzes the performance differences between standard UV coatings and advanced hard coating systems, providing data-driven selection criteria for engineers.

> **Quick Answer:** Hard-coated polycarbonate with silicone-based coatings provides 15-20 year service life vs 3-5 years for uncoated sheets in high-UV environments.

---

## 1. UV Degradation Mechanisms

### 1.1 Photochemical Breakdown

Polycarbonate absorbs UV radiation below 380nm, triggering:
- Chain scission (molecular weight reduction)
- Yellowing (chromophore formation)  
- Surface embrittlement (micro-cracking)

### 1.2 Performance Impact Timeline

| Exposure Duration | Uncoated PC | Standard UV Coating | Hard Coating |
|-------------------|-------------|---------------------|--------------|
| 1 year | 15% yellowing | 2% yellowing | <1% yellowing |
| 5 years | Failed | 8% yellowing | 3% yellowing |
...
|----------|-------|-------------|
| Coating Type | UV-cured silicone | - |
| Pencil Hardness | 2H-4H | ASTM D3363 |
| UV Cutoff | 380-400nm | Spectrophotometry |
| Coating Thickness | 3-5 μm | Cross-section microscopy |
| Abrasion Resistance | <5% haze after 1000 cycles | ASTM D1044 |

### 2.2 Multi-Function Benefits

Hard coatings provide simultaneous protection against:
- **UV radiation:** 99% absorption above 380nm
- **Scratch damage:** 10x improvement over uncoated
- **Chemical exposure:** Resistant to common cleaning agents

---

## 3. Application Selection Matrix

### 3.1 Recommended Products by Environment
...
### 4.1 Coating Orientation

**Critical:** Hard coating must face the UV source (typically exterior)

Common installation errors:
- ❌ Coating facing interior (rapid exterior degradation)
- ❌ Double-sided hard coating on curved panels (stress cracking)
- ✅ Single-sided hard coating, UV-side out
- ✅ 2-3mm expansion gaps per meter
...
### 6.1 Lifecycle Cost Comparison (20-year horizon)

**Scenario:** 1000m² commercial greenhouse roofing

| System | Initial Cost | Replacement Cycle | 20-Year Total |
|--------|--------------|-------------------|---------------|
| Uncoated PC (6mm) | $18,000 | Every 3-4 years | $108,000 |
| Standard UV coating | $22,000 | Every 8-10 years | $44,000 |
| Hard coated PC | $35,000 | Every 15-20 years | $35,000 |

**Result:** Hard coating provides 67% lifecycle cost savings vs uncoated.
...
*Disclaimer: This guide provides general engineering principles. Always consult local building codes and conduct site-specific UV exposure assessments for outdoor installations.*
